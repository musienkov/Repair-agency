            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="title-login" align="center">
                        <h2><fmt:message key="ADD_HALL"/></h2>
                    </div>




                    <form action="${pageContext.request.contextPath}/servlet/makeorder" method="post" align="center">

                        <div class="form-group">
                            <label for="order_info"><fmt:message key="ORDER_INFO"/> </label>
                           <p id = order_info>${order_info}</p>
                        </div>
