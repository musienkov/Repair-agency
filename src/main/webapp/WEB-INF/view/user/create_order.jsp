            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="title-login" align="center">
                        <h2><fmt:message key="CREATE_ORDER"/></h2>
                    </div>




                    <form action="${pageContext.request.contextPath}/servlet/neworder" method="post" align="center">

                        <div class="form-group">
                            <label for="productname"><fmt:message key="PRODUCT_NAME"/> </label>
                            <input type="text" required class="form-control" id="productname" name="productname">
                        </div>

                        <div class="form-group">
                            <label for="info"><fmt:message key="PRODUCT_INFO"/> </label>
                            <input type="text" required class="form-control" id="info" name="info">
                        </div>
