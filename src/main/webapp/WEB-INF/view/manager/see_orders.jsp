            ...
            <c:if test="${fn:length(orderList) gt 0}">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th><fmt:message key="PRODUCT_INFO"/> </th>
                    ...
                    <c:forEach var="i" items="${orderList}" varStatus="status">
                        <tr>
                            ...
                            <th>${i.info}</th>
                                ...
                                <form  action="${pageContext.request.contextPath}/servlet/gotoacceptorder" >
                                    <th>
                            ...
                            <form  action="${pageContext.request.contextPath}/servlet/gotorefuseorder" >
                            <th>
