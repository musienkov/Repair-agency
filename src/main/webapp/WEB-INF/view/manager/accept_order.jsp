            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="title-login" align="center">
                        <h2><fmt:message key="ACCEPT_ORDER"/></h2>
                    </div>




                    <form action="${pageContext.request.contextPath}/servlet/acceptorder" method="post" align="center">

                        <div class="form-group">
                            <label for="price"><fmt:message key="PRICE_ORDER"/> </label>
                            <input type="number" required class="form-control" id="price" name="price">
                        </div>

                        <div class="form-group">
                            <label for="manager"><fmt:message key="MASTER"/> </label>

                            <select id="manager" class="form-control" name = "masterLogin">
                            <c:forEach var="i" items="${masterList}" varStatus="status">
